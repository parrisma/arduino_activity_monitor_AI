...
class TFLiteGenerator:
    ...
    def _generate_h_file(model_name: str) -> str:
        ...
        h_str += ' *\n'
        h_str += ' * It defines an array that holds the quantized and exported version of\n'
        h_str += ' * a trained TensorFlow model that can be imported onto a platform that\n'
        h_str += ' * supports tensor flow lite, such as Arduino Nano Sense 33 BLE\n'
        h_str += ' * \n'
        h_str += ' * It also defines the byte length of that array\n'
        h_str += ' * \n'
        h_str += '*/\n\n'
    ...
    def _generate_cpp_file(header_file_name: str,
        ...
        cpp_str += ' *\n'
        cpp_str += ' * It declares an array literal that holds the quantized and exported version of\n'
        cpp_str += ' * a trained TensorFlow model that can be imported onto a platform that\n'
        cpp_str += ' * supports tensor flow lite, such as Arduino Nano Sense 33 BLE\n'
        cpp_str += ' * \n'
        cpp_str += ' * It also declares the byte length of that array as an integer constant\n'
        cpp_str += ' * \n'
        cpp_str += '*/\n\n'
